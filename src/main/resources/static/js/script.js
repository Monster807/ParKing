...
const paymentStart = () => {
    var amount =  $("#outTime").val()-$("#inTime").val() + ($("#days").val() )*24 ;
    var options = {
        "key": "rzp_test_haDRsJIQo9vFPJ",
        "amount": amount*2500 +10000,
        "name": "ParkingPro",
        "description": "Proceed to make payment",
        "image": "https://dcmnyjhirotcw.cloudfront.net/cdn/scdn/images/uploads/7a060bb_web_600_update.jpg",
